...
class FontPage(Frame):
    ...
    def create_page_font_tab(self):
        ...
        frame_font = LabelFrame(
                self, borderwidth=2, relief=GROOVE, text=' 文本字体 ')
        frame_sample = LabelFrame(
                self, borderwidth=2, relief=GROOVE,
                text=' 样例（可编辑） ')
        frame_indent = LabelFrame(
                self, borderwidth=2, relief=GROOVE, text=' 缩进宽度 ')
        # frame_font.
...
class HighPage(Frame):
    ...
    def create_page_highlight(self):
        ...
        self.theme_elements = {
            '一般代码文本': ('normal', '00'),
            '代码上下文': ('context', '01'),
            'Python 关键词': ('keyword', '02'),
            'Python 定义': ('definition', '03'),
            'Python 内置对象': ('builtin', '04'),
            'Python 注释': ('comment', '05'),
            'Python 字符串': ('string', '06'),
            '选中文本': ('hilite', '07'),
            '搜索结果': ('hit', '08'),
            '光标': ('cursor', '09'),
            '编辑器断点': ('break', '10'),
...
class KeysPage(Frame):
    ...
    def get_new_keys(self):
        ...
        new_keys = GetKeysDialog(self, '设置快捷键', bind_name,
...
class GenPage(Frame):
    ...
    def create_page_general(self):
        ...
        cursor_blink_title = Label(frame_cursor_blink, text='光标闪烁')
