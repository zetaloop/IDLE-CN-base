...
class AboutDialog(Toplevel):
    ...
    def create_widgets(self):
        ...
        forums = Button(frame_background, text='Python（与 IDLE）论坛', width=35,
                                 highlightbackground=self.bg,
                                 command=lambda: webbrowser.open(forums_url))
        forums.grid(row=6, column=0, sticky=W, padx=10, pady=10)


        docs_url = ("https://docs.python.org/zh-cn/%d.%d/library/idle.html" %
                    sys.version_info[:2])
        docs = Button(frame_background, text='IDLE 文档', width=35,
                                 highlightbackground=self.bg,
        ...
        tkver = ' 与 ' + tkpatch if tkpatch != tclver else ''
        versions = f"Python {pyver} 和 tcl/tk {tclver}{tkver}"
    ...
    def show_idle_news(self):
        ...
        self.display_file_text('关于 - 更新日志', 'News3.txt', 'utf-8')
